...
final String contactTable = "tb_contact";
final String idColumn = "col_id";
final String nameColumn = "col_name";
final String emailColumn = "col_email";
final String phoneColumn = "col_phone";
final String imageColumn = "col_image";
...
class ContactHelper {
	...
	Future<int> updateContact(Contact contact) async {
		...
		return await dbContact.update(
			contactTable, contact.toMap(), where: "$idColumn = ?", whereArgs: [contact.id]);
	}
